...
const getDriverRating = (claimHistory) => {
    let driverRating; // rating of driver (1 - 5)
    let occurrences; // number of occurrences of words
    let driverHistory; // history of driver
    let occurrencesArray; //Occurrences to check
...
exports.default = getDriverRating;
